...
uint256 hashGenesisBlock("0x5cd66be181d114465980ab785ad1476a16f60f1239a1cb5f576e66f3da025f1c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // KCARAT: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "KCARAT Signed Message:\n";
...
{
    // KCARAT: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if (nHeight==2) 
	{
    		nSubsidy  = 8400000000 * COIN;
	} else {
    		nSubsidy  = 0;
	}

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 8400000); // KCARAT: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // KCARAT: 3.5 days
static const int64 nTargetSpacing = 30; // KCARAT: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // KCARAT: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // KCARAT: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // KCARAT: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0b38290735dc085da45c8828e663452de97cbee4e9bc2bfd9cfd5c957326e3d8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("5ab7a58ca5068cce09ac15fa459011872ef2c9eb39f325d93cf165ae41f68632247cd298907a083b5bf86e71d6a15783363531d92b3b0b923c8e6dad7da16a49b7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1526035708;
        block.nBits    = 504365644;
        block.nNonce   = 1053843070;

        if (fTestNet)
        {
            block.nTime    = 1526035708;
            block.nNonce   = 1266678353;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xde57b227956ab16ade97ed2cac2e39da71f58036d158f25ea3427d7ea1b0a851"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // KCARAT: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KCARATMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KCARATMiner : ProcessBlock, block not accepted");
    }
